...
// Payment of $0.10 USDC happens automatically (LAUNCH WEEK SPECIAL)
...
**Price:** $0.10 USDC (Base network) - 🔥 LAUNCH WEEK SPECIAL (87% OFF)
...
**Earnings:** $0.10 per scan during Launch Week (regular $0.75) × number of scans
